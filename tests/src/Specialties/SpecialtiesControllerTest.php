...
use VetClinic\Specialties\{ SpecialtiesDto, SpecialtiesModel, SpecialtiesController };
...
class SpecialtiesControllerTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->service = $this->createMock("VetClinic\Specialties\ISpecialtiesService");
        $this->request = $this->createMock("Psr\Http\Message\ServerRequestInterface");
        $this->stream = $this->createMock("Psr\Http\Message\StreamInterface");
        $this->controller = new SpecialtiesController(
            $this->service
        );

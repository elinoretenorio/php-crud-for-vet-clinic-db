...
use VetClinic\Types\{ TypesDto, TypesModel, ITypesService, TypesService };

class TypesServiceTest extends TestCase
{
    private $repository;
    private array $input;
    ...
    {
        $this->repository = $this->createMock("VetClinic\Types\ITypesRepository");
        $this->input = [
            "id" => 4109,
            "name" => "million",
        ];

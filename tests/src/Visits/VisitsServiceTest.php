...
use VetClinic\Visits\{ VisitsDto, VisitsModel, IVisitsService, VisitsService };
...
class VisitsServiceTest extends TestCase
{
    ...
    {
        $this->repository = $this->createMock("VetClinic\Visits\IVisitsRepository");
        $this->input = [
            "id" => 5129,
            "pet_id" => 167,
        ...
        $this->service = new VisitsService($this->repository);
    }

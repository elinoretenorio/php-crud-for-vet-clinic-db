...
use VetClinic\Visits\{ VisitsDto, VisitsModel, VisitsController };
...
class VisitsControllerTest extends TestCase
{
    ...
    private $request;
    private $stream;
    private VisitsController $controller;
    ...
    protected function setUp(): void
    {
        $this->input = [
            "id" => 1386,
            "pet_id" => 2132,
            "visit_date" => "2021-09-28",
            "description" => "size",
        ];
        $this->dto = new VisitsDto($this->input);
        $this->model = new VisitsModel($this->dto);
        $this->service = $this->createMock("VetClinic\Visits\IVisitsService");
